...
public class ClientMessager {
    ...
    public ClientMessager() {
        ...
        headingLabel = new JLabel("Zwaga Active");
        headingLabel.setPreferredSize(new Dimension(70, 70));
    ...
    private class sendMessage implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                Logger.getLogger(ClientMessager.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            socket = new Socket("localhost", 1527);
            ...
            while (!servermessage.equalsIgnoreCase("bye")) {
                ...
                JLabel output1 = new JLabel(servermessage);
                ...
                if (themessage.equalsIgnoreCase("bye")) {
                    System.exit(0);
                    break;
                }
            }
